...
const LandingPage = ({ setGetInfo, aiRes }) => {
  ...
  function handleSubmit(e) {
    ...
    //  ****************     TO CHECK WHAT INFORMATION DATA HAVE     ************************* 
    // console.log(data);
    setGetInfo(data);

    // *********************  DUE TO THIS INPUT FIELD BECOME EMPTY AFTER SUBMISION ********************
    SetData(initialState);
  }
  return (
    <>
      <h1>
        BUY BEST ELECTRONICS PRODUCT USING AI{' '}
        <span>
          <AiFillRobot />
        </span>
      </h1>
   ...
   {/* *************   TAKING INPUT FROM USER      ***************************** */}
        ...
        <form>
          ...
          <input
            type="text"
            placeholder="mobile,laptop,tablet,etc"
          ...
          <input
            type="text"
            id="company"
            placeholder="vivo,oppo,dell,hp etc"
            name="company"
            onChange={handleChange}
            value={data.company}
          />
          ...
          >
            ...
            <option value="200k-1000k">200k-1000k</option>
          </select>
          ...
          <svg
            ...
            viewBox="0 0 197.60004 221.93357"
            className="svg"
          >
            <g id="Big-Bg">
              <path
        ...
        <div className="output">
          ...
          <textarea
            ...
            cols="70"
            rows="25"
            placeholder="Wait for AI response it may take 5-10s to response"
            readOnly
          ></textarea>
        </div>
      </div>
